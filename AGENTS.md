...
**Паспорт/ID (ЗРУ-600 прил. п. 6 в ред. ЗРУ-759 от 14.03.2022):** ID-карта 0,89 БРВ в любом возрасте, загранпаспорт
**1 БРВ** (1,2 — редакция ДО 14.03.2022, жила в коде по статье gazeta.uz 2020 года), до 16 лет 0,8 БРВ; срочной пошлины и
удвоения при утере НЕТ; через my.gov.uz за загранпаспорт 90% (ПП-4079 п. 27). **Топливо** — рыночное, ориентир сеть
«Узбекнефтегаз» (autostrada.uz/benzin/), `FUEL_PRICES_DATE`; в калькуляторе расхода есть поле своей цены.
