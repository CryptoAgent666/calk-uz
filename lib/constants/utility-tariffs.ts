...
/**
 * Сводный тариф по счётчику для «4-кода» Ташкента (UZS за м³) — питьевая вода
 * ПЛЮС водоотведение, а не цена одной холодной воды.
 *
 * Официальные составляющие с НДС (Toshsuvta'minoti): питьевая вода 1 568 сум/м³,
 * сточные воды 1 120 сум/м³. Нетто-тарифы (1 400 / 1 000) не менялись с
 * 15.12.2023; версия с НДС действует с 01.04.2024 — из-за отмены льготы по НДС
 * на коммунальные услуги, а не из-за повышения самих тарифов.
 * ⚠️ ПКМ-243 от 15.05.2026 поднял электричество и газ, воды он НЕ касался.
 */
// Это ставка ТОЛЬКО города Ташкента (дом с центральным ГВС). Региональные тарифы
// и расчёт по категориям жилья — lib/constants/utility-regions.ts.
