    ...
    cases: [
      {
        ...
        stepsRu: [
          ...
          { label: 'из них ИНПС (0,1%) — на счёт работника', value: '25 000 сум' },
          { label: 'На руки', value: '23 125 000 сум' },
        ...
        stepsUz: [
          ...
          { label: "shundan IJPH (0,1%) — xodim hisobiga", value: "25 000 so'm" },
          { label: "Qo'lga", value: "23 125 000 so'm" },
      ...
      },
      {
        ...
        stepsRu: [
          ...
          { label: 'из них ИНПС 0,1% — на счёт работника', value: '7 000 сум' },
          { label: 'На руки', value: '6 160 000 сум' },
        ...
        stepsUz: [
          ...
          { label: "shundan IJPH 0,1% — xodim hisobiga", value: "7 000 so'm" },
          { label: "Qo'lga", value: "6 160 000 so'm" },
    ...
    cases: [
      {
        ...
        stepsRu: [
          ...
          { label: 'Делитель (1 − 0,12)', value: '0,88' },
          { label: 'Начисленная зарплата', value: '11 363 636 сум' },
          { label: 'НДФЛ 12%', value: '1 363 636 сум' },
          { label: 'из них ИНПС 0,1% — на счёт работника', value: '11 364 сум' },
          { label: 'Соцналог (12%, оплачивает работодатель)', value: '1 363 636 сум' },
          { label: 'Полная стоимость для работодателя', value: '12 727 273 сум' },
        ],
        stepsUz: [
          { label: "Sof ish haqi (qo'lga)", value: "10 000 000 so'm" },
          { label: "Bo'luvchi (1 − 0,12)", value: "0,88" },
          { label: "Hisoblangan ish haqi", value: "11 363 636 so'm" },
          { label: "JShShS 12%", value: "1 363 636 so'm" },
          { label: "shundan IJPH 0,1% — xodim hisobiga", value: "11 364 so'm" },
          { label: "Ijtimoiy soliq (12%, ish beruvchi)", value: "1 363 636 so'm" },
          { label: "Ish beruvchining to'liq xarajati", value: "12 727 273 so'm" },
        ],
        conclusionRu:
          'Работодатель тратит 12,7 млн, чтобы сотрудник получил 10 млн на руки. «Накладные» — 27,3% от чистой зарплаты.',
        conclusionUz:
          "Xodim qo'lga 10 mln olishi uchun ish beruvchi 12,7 mln sarflaydi. «Qo'shimcha» — sof ish haqining 27,3%.",
      },
    ],
  },
  {
    ...
    cases: [
      {
        ...
        contextRu: 'Стоимость в ОАЭ 1 200 USD, прилёт самолётом после 5 дней за рубежом, для личного пользования',
        contextUz: "BAAdagi narxi 1 200 USD, chet elda 5 kun bo'lgach samolyotda qaytish, shaxsiy foydalanish uchun",
        stepsRu: [
          { label: 'Стоимость (курс ЦБ 11 801,23, 28.08.2026)', value: '14 161 476 сум' },
          { label: 'Беспошлинная норма при въезде самолётом (1 000 USD)', value: '11 801 230 сум' },
          { label: 'Сумма сверх нормы (200 USD)', value: '2 360 246 сум' },
          { label: 'Единый таможенный платёж: 30% от превышения, не менее $3 за 1 кг (60 USD)', value: '708 074 сум' },
          { label: 'Итого с платежом', value: '14 869 550 сум' },
        ],
        stepsUz: [
          { label: "Narxi (MB kursi 11 801,23, 28.08.2026)", value: "14 161 476 so'm" },
          { label: "Samolyotda kirishda bojsiz norma (1 000 USD)", value: "11 801 230 so'm" },
          { label: "Normadan ortiq summa (200 USD)", value: "2 360 246 so'm" },
          { label: "Yagona bojxona to'lovi: ortig'idan 30%, 1 kg uchun kamida $3 (60 USD)", value: "708 074 so'm" },
          { label: "To'lov bilan jami", value: "14 869 550 so'm" },
        ],
        conclusionRu:
          'Единый таможенный платёж заменяет пошлину, НДС и акциз. Норма 1 000 USD действует при въезде самолётом, если вы пробыли за рубежом не менее 3 календарных дней; при более короткой поездке платёж берётся со всей стоимости — 360 USD (~4 248 000 сум). С 1 января 2027 года ставка снижается до 20% (не менее $2 за 1 кг), и за этот же телефон придётся заплатить 40 USD.',
        conclusionUz:
          "Yagona bojxona to'lovi boj, QQS va aksiz o'rniga olinadi. 1 000 USD norma samolyotda kirishda, agar chet elda kamida 3 kalendar kun bo'lgan bo'lsangiz, amal qiladi; safar qisqaroq bo'lsa, to'lov butun qiymatdan olinadi — 360 USD (~4 248 000 so'm). 2027-yil 1-yanvardan stavka 20% gacha (1 kg uchun kamida $2) tushiriladi va xuddi shu telefon uchun 40 USD to'lanadi.",
      },
    ],
  },
  {
    ...
    cases: [
      {
        ...
        stepsRu: [
          { label: 'Госпошлина за регистрацию брака (0,2 БРВ)', value: '88 000 сум' },
        ...
        stepsUz: [
          { label: "Nikohni ro'yxatdan o'tkazish boji (0,2 BHK)", value: "88 000 so'm" },
