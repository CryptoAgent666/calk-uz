...
export const CALCULATOR_ARTICLES: CalculatorArticle[] = [
...

  {
    ...
    paragraphsRu: [
      ...
      'Примеры использования БРВ: порог для обязательной регистрации плательщиком НДС — 12 000 БРВ = 4 944 000 000 сум; штраф за вождение без полиса ОСАГО — 0,5 БРВ = 206 000 сум; гарантия по банковским вкладам — ~486 БРВ (200 000 000 сум); имущественный вычет по НДФЛ — 500 БРВ = 206 000 000 сум; материальная помощь, не облагаемая НДФЛ — 4,22 БРВ = 1 738 640 сум/год.',
