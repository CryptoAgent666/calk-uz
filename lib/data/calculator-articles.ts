...
export const CALCULATOR_ARTICLES: CalculatorArticle[] = [
...

  {
    ...
    paragraphsRu: [
      ...
      'С 1 января 2026 года электромобили облагаются транспортным налогом на общих основаниях: действовавшее ранее освобождение истекло 31 декабря 2025 года и не было продлено. При ввозе электромобили по-прежнему освобождены от таможенной пошлины (до 1 января 2030 года). Гибридные автомобили облагаются по ставке 50% от базовой для соответствующего объёма двигателя. Количество электромобилей в Узбекистане в 2025 году превысило 30 000 единиц.',
    ...
    paragraphsUz: [
      ...
      "2026-yil 1-yanvardan boshlab elektromobillar umumiy asosda transport solig'iga tortiladi: avval amalda bo'lgan ozodlik 2025-yil 31-dekabrda tugadi va uzaytirilmadi. Import qilishda elektromobillar hozircha bojxona bojidan ozod (2030-yil 1-yanvargacha). Gibrid avtomobillar tegishli dvigatel hajmi uchun bazaviy stavkaning 50% stavkasida soliqqa tortiladi. 2025-yilda O'zbekistondagi elektromobillar soni 30 000 birlikdan oshdi.",
    ...
    faqRu: [
      ...
      { question: 'Облагаются ли электромобили?', answer: 'Да, с 2026 года электромобили облагаются транспортным налогом — действовавшее освобождение истекло 31.12.2025 и не было продлено. Гибриды — 50% от базовой ставки.' },
      { question: 'Когда нужно платить?', answer: 'Равными долями до 15 апреля и 15 октября текущего года. Оплата через my.soliq.uz, Click, Payme или банковские терминалы.' },
    ...
    faqUz: [
      ...
      { question: "Elektromobillar soliqqa tortiladimi?", answer: "Ha, 2026-yildan elektromobillar transport solig'iga tortiladi — ozodlik 2025-yil 31-dekabrda tugadi va uzaytirilmadi. Gibridlar — bazaviy stavkaning 50%." },
      { question: "Qachon to'lash kerak?", answer: "Teng ikki qismda 15-aprel va 15-oktabrgacha. my.soliq.uz, Click, Payme yoki bank terminallari orqali to'lash mumkin." },
