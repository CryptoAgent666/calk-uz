...
export const CALCULATOR_ARTICLES: CalculatorArticle[] = [
...

  {
    ...
    paragraphsRu: [
      ...
      'Единовременная материальная помощь при рождении ребёнка может выплачиваться работодателем, однако единой государственной ставки в БРВ для неё нет — размер устанавливается коллективным договором или внутренними актами. Дополнительно государство выплачивает ежемесячное пособие семьям с детьми до 2 лет через систему социальной защиты — размер зависит от дохода семьи и количества детей.',
    ...
    paragraphsUz: [
      ...
      "Bola tug'ilganda bir martalik moddiy yordam ish beruvchi tomonidan to'lanishi mumkin, lekin buning uchun yagona davlat stavkasi (BHKda) yo'q — miqdor jamoa shartnomasi yoki ichki hujjatlar bilan belgilanadi. Qo'shimcha ravishda davlat ijtimoiy himoya tizimi orqali 2 yoshgacha bolali oilalarga oylik nafaqa to'laydi — miqdori oila daromadi va bolalar soniga bog'liq.",
    ...
    faqRu: [
      ...
      { question: 'Какое единовременное пособие при рождении?', answer: 'Единой государственной ставки нет — выплата устанавливается работодателем (коллективный договор / внутренние акты).' },
    ...
    faqUz: [
      ...
      { question: "Tug'ilganda bir martalik nafaqa qancha?", answer: "Yagona davlat stavkasi yo'q — to'lov ish beruvchi tomonidan belgilanadi (jamoa shartnomasi / ichki hujjatlar)." },
