...
export const CALCULATOR_ARTICLES: CalculatorArticle[] = [
...

  {
    ...
    paragraphsRu: [
      ...
      'Максимальная продолжительность сверхурочных работ строго ограничена Трудовым кодексом: не более 4 часов за 2 дня подряд (годовой лимит 120 ч отменён с 2026). Привлечение к сверхурочной работе допускается только с письменного согласия работника. Запрещено привлекать: беременных женщин, работников до 18 лет, инвалидов (без их письменного согласия и медицинского заключения об отсутствии противопоказаний).',
    ...
    paragraphsUz: [
      ...
      "Ortiqcha ishning maksimal davomiyligi Mehnat kodeksi bilan qat'iy cheklangan: ketma-ket 2 kun uchun 4 soatdan ko'p emas (yillik 120 soatlik limit 2026-yildan bekor qilingan). Ortiqcha ishga jalb qilish faqat xodimning yozma roziligi bilan ruxsat etiladi. Taqiqlangan: homilador ayollar, 18 yoshgacha xodimlar, nogironlar (ularning yozma roziligi va tibbiy xulosasiz).",
    ...
    faqRu: [
      ...
      { question: 'Сколько часов можно работать сверхурочно?', answer: 'До 4 часов за 2 дня подряд (годовой лимит 120 ч отменён с 2026). Только с письменного согласия работника.' },
    ...
    faqUz: [
      ...
      { question: "Necha soat ortiqcha ishlash mumkin?", answer: "Ketma-ket 2 kun uchun 4 soatgacha (yillik 120 soatlik limit 2026-yildan bekor qilingan). Faqat xodimning yozma roziligi bilan." },
...

  {
    ...
    paragraphsRu: [
      ...
      'Стоимость отопления за сезон 2025-2026 (квартира 60 м² в Ташкенте): центральное отопление — 1 800 000-2 500 000 сум (плата по нормативу ~420 000 сум/мес); индивидуальный газовый котёл — 2 750 000-4 950 000 сум (расход газа 300-500 м³/мес по тарифу 1 100 сум/м³); электрические обогреватели — 8 400 000-16 300 000 сум (расход 2 000-3 500 кВт·ч/мес: из-за ступенчатого тарифа эффективная цена достигает 1 275-1 415 сум/кВт·ч, а не базовых 650).',
