...
export const CALCULATOR_ARTICLES: CalculatorArticle[] = [
...

  {
    ...
    paragraphsUz: [
      "O'zbekistonda jismoniy shaxslarning mol-mulk solig'i ko'chmas mulk ob'ektining kadastr qiymatidan hisoblanadi. 2026-yildan bazaviy stavkalar 7% ga indeksatsiya qilindi. Stavkalar differentsiyalangan: 200 m² gacha turar-joy binolari kadastr qiymatining 0,36% stavkada, 200 dan 500 m² gacha maydon uchun 0,48%, 500 m² dan ortiq — 0,64%. Ayrim toifalar uchun pasaytirilgan stavka 0,70% (avval 0,65%). Kadastr qiymati Davlat kadastr palatasi tomonidan aniqlanadi va davriy ravishda qayta ko'rib chiqiladi.",
    ...
    faqRu: [
      { question: 'Какая ставка налога на имущество?', answer: 'Для физлиц (с 2026, +7% индексация): 0,36% (до 200 м²), 0,48% (200-500 м²), 0,64% (свыше 500 м²) от кадастровой стоимости. Пониженная — 0,70%. Для юрлиц: 1,5% от остаточной стоимости.' },
    ...
    faqUz: [
      { question: "Mol-mulk solig'i stavkasi qancha?", answer: "Jismoniy shaxslar uchun (2026-yildan, +7% indeksatsiya): 0,36% (200 m² gacha), 0,48% (200-500 m²), 0,64% (500 m² dan ortiq) kadastr qiymatidan. Pasaytirilgan — 0,70%. Yuridik shaxslar uchun: qoldiq qiymatdan 1,5%." },
...

  {
    ...
    faqUz: [
      ...
      { question: "Soliq huquqbuzarliklari uchun qanday jarimalar bor?", answer: "Deklaratsiya topshirmaslik: 1-3 BHK. Soliq bazasini yashirish (kamaytirish): yashirilgan baza summasining 20%, undan soliqlar esa jarimadan tashqari hisoblanadi (SK 223-moddasi). Noto'g'ri hisoblash tufayli to'liq to'lamaslik: to'lanmagan soliq summasining 20% (SK 224-moddasi). Ro'yxatdan o'tmasdan faoliyat: daromadning 10%, kamida 1 mln so'm." },
...

  {
    ...
    paragraphsRu: [
      ...
      'Выплаты по больничному листу облагаются НДФЛ 12% (взнос ИНПС 0,1% входит в эти 12%, а не удерживается сверху), но не облагаются социальным налогом. Больничный не оплачивается, если нетрудоспособность наступила в результате умышленного причинения вреда здоровью, при нахождении под арестом или в период отпуска без сохранения зарплаты. Работодатель обязан принять больничный лист и произвести расчёт в течение 10 рабочих дней.',
