...
export const CALCULATOR_ARTICLES: CalculatorArticle[] = [
...

  {
    ...
    paragraphsRu: [
      ...
      'Налоговый кодекс предусматривает ряд вычетов и освобождений. Не облагаются НДФЛ: алименты, государственные пенсии, стипендии, материальная помощь в пределах 4,22 МРОТ (5 363 620 сум) в год от работодателя, компенсации за неиспользованный отпуск при увольнении, страховые выплаты. Также действует льгота по НДФЛ на доходы, направляемые на погашение ипотечного кредита и процентов по нему, — до 80 МРОТ (101 680 000 сум) за календарный год (п. 16 ст. 378 НК). Индивидуальные предприниматели на общей системе налогообложения уплачивают НДФЛ с чистого дохода (доходы минус документально подтверждённые расходы).',
    ...
    paragraphsUz: [
      ...
      "Soliq kodeksida bir qator chegirmalar va ozod qilishlar nazarda tutilgan. JShShSga tortilmaydi: nafaqa, davlat pensiyalari, stipendiyalar, ish beruvchidan yiliga 4,22 MIH (5 363 620 so'm) doirasidagi moddiy yordam, ishdan bo'shatilganda foydalanilmagan ta'til uchun kompensatsiya, sug'urta to'lovlari. Shuningdek, ipoteka kreditini va u bo'yicha foizlarni to'lashga yo'naltirilgan daromadlar kalendar yil davomida 80 MIH gacha (101 680 000 so'm) JShShSdan ozod qilinadi (SK 378-moddasi 16-bandi).",
    ...
    faqRu: [
      ...
      { question: 'Какие доходы не облагаются НДФЛ?', answer: 'Не облагаются: алименты, пенсии, стипендии, материальная помощь до 4,22 МРОТ в год (5 363 620 сум), компенсации при увольнении, страховые выплаты.' },
      ...
      { question: 'Есть ли льгота по НДФЛ при покупке жилья в ипотеку?', answer: 'Да. Доходы, направляемые на погашение ипотечного кредита и процентов по нему, освобождаются от НДФЛ в пределах 80 МРОТ (101 680 000 сум) за календарный год — п. 16 ст. 378 НК. Условие: жильё приобретено, построено или реконструировано с субсидией из бюджета; для молодых семей — без этого условия. Если жильё продать в течение 36 месяцев, льгота аннулируется.' },
    ...
    faqUz: [
      ...
      { question: "Qanday daromadlar JShShSga tortilmaydi?", answer: "Tortilmaydi: nafaqa, pensiya, stipendiya, yiliga 4,22 MIH gacha moddiy yordam (5 363 620 so'm), ishdan bo'shatilgandagi kompensatsiya, sug'urta to'lovlari." },
...

  {
    ...
    faqRu: [
      ...
      { question: 'Кто обязан платить НДС?', answer: 'Юридические лица и ИП с совокупным доходом за налоговый период свыше 12 000 БРВ (4 944 000 000 сум при БРВ 412 000). Остальные могут зарегистрироваться добровольно.' },
    ...
    faqUz: [
      ...
      { question: "QQS to'lash kimga majburiy?", answer: "Soliq davri uchun umumiy daromadi 12 000 BHK dan (412 000 so'mlik BHKda 4 944 000 000 so'mdan) ortiq yuridik shaxslar va YaTTlarga. Qolganlari ixtiyoriy ro'yxatdan o'tishi mumkin." },
...

  {
    ...
    paragraphsUz: [
      ...
      "OSAGO polisi 12 oyga rasmiylashtiriladi va sug'urta kompaniyalari ofislarida yoki onlayn sotib olinishi mumkin. OSAGOsiz haydash — ma'muriy huquqbuzarlik (MJtKning 135-1-moddasi): 1 BHK jarima (412 000 so'm). Bu modda bo'yicha ogohlantirish nazarda tutilmagan.",
    ],
    faqRu: [
      ...
      { question: 'Какой штраф за езду без ОСАГО?', answer: 'Штраф 1 БРВ (412 000 сум) по ст. 135-1 Кодекса об административной ответственности. Предупреждение не предусмотрено.' },
    ...
    faqUz: [
      ...
      { question: "OSAGOsiz haydash uchun jarima qancha?", answer: "1 BHK (412 000 so'm) jarima — MJtKning 135-1-moddasi bo'yicha. Ogohlantirish nazarda tutilmagan." },
...

  {
    ...
    paragraphsUz: [
      ...
      "Kvartira sotib olishda qo'shimcha xarajatlarni hisobga oling: shartnomani notarial rasmiylash — belgilangan boj 1 BHK (412 000 so'm); ro'yxatdan o'tish davlat boji (maydon bo'yicha) — 100 m² gacha 1,25 BHK (515 000 so'm), 101-300 m² 2 BHK, 300 dan ortiq 3 BHK; ko'chmas mulk baholash — 200 000-500 000 so'm; rieltor xizmatlari — qiymatning 1-2%; ta'mir — 3 000 000 dan 8 000 000 so'm/m² gacha.",
    ],
    faqRu: [
      ...
      { question: 'Какие дополнительные расходы при покупке квартиры?', answer: 'Нотариус — фикс. 1 БРВ (412 000 сум), госпошлина за регистрацию — 1,25-3 БРВ по площади (до 100 м² — 1,25 БРВ), оценка (до 500 000 сум), риелтор (1-2%). Суммарно: 1-3% от стоимости.' },
    ...
    faqUz: [
      ...
      { question: "Kvartira sotib olishda qo'shimcha xarajatlar qanday?", answer: "Notarius — belgilangan 1 BHK (412 000 so'm), ro'yxatdan o'tish boji — maydon bo'yicha 1,25-3 BHK (100 m² gacha — 1,25 BHK), baholash (500 000 so'mgacha), rieltor (1-2%). Jami: qiymatning 1-3%." },
...

  {
    ...
    faqRu: [
      ...
      { question: 'Какой порог для уплаты НДС?', answer: '12 000 БРВ (4 944 000 000 сум) — совокупный доход за налоговый период. Ниже этого порога ИП не платит НДС.' },
    ...
    faqUz: [
      { question: "O'zbekistonda YaTT qancha soliq to'laydi?", answer: "Aylanma solig'i 1% + ijtimoiy soliq 412 000 so'm/oy + IJPH 0,1%." },
      ...
      { question: "QQS to'lash uchun chegara qancha?", answer: "12 000 BHK (4 944 000 000 so'm) — soliq davri uchun umumiy daromad. Bu chegaradan past bo'lsa YaTT QQS to'lamaydi." },
...

  {
    ...
    paragraphsRu: [
      'Базовая расчётная величина (БРВ) в Узбекистане с августа 2025 года составляет 412 000 сум; с 1 сентября 2026 года она повышается до 440 000 сум (Указ ПФ-115 от 23.06.2026). БРВ — это универсальный экономический показатель, который используется для расчёта штрафов, государственных пошлин, социальных пособий, налоговых порогов и ограничений. Калькулятор БРВ переводит суммы из БРВ в сумы и обратно, что необходимо для понимания законодательных норм и расчёта платежей.',
      ...
      'Примеры использования БРВ: порог для обязательной регистрации плательщиком НДС — 12 000 БРВ = 4 944 000 000 сум; штраф за вождение без полиса ОСАГО — 1 БРВ = 412 000 сум; гарантия по банковским вкладам — ~486 БРВ (200 000 000 сум). Внимание: не все налоговые лимиты считаются в БРВ — льготы по НДФЛ привязаны к МРОТ (1 271 000 сум): необлагаемая материальная помощь — 4,22 МРОТ = 5 363 620 сум/год, погашение ипотеки — до 80 МРОТ = 101 680 000 сум/год.',
      ...
      'Для быстрого расчёта: 1 БРВ = 412 000 сум; 10 БРВ = 4 120 000 сум; 100 БРВ = 41 200 000 сум; 1 000 БРВ = 412 000 000 сум; 10 000 БРВ = 4 120 000 000 сум. При чтении законодательных актов, где суммы указаны в БРВ, используйте наш калькулятор для мгновенного перевода в сумы.',
    ],
    paragraphsUz: [
      "O'zbekistonda bazaviy hisoblash kattaligi (BHK) 2025-yil avgustidan 412 000 so'mni tashkil etadi; 2026-yil 1-sentabrdan u 440 000 so'mgacha oshiriladi (23.06.2026-yildagi PF-115 Farmoni). BHK — jarimalar, davlat bojlari, ijtimoiy nafaqalar, soliq chegaralari va cheklovlarni hisoblash uchun ishlatiladigan universal iqtisodiy ko'rsatkich. BHK kalkulyatori summalarni BHKdan so'mga va aksincha o'giradi.",
      ...
      "BHK qo'llanilishi misollari: QQS to'lovchisi sifatida majburiy ro'yxatdan o'tish chegarasi — 12 000 BHK = 4 944 000 000 so'm; OSAGOsiz haydash uchun jarima — 1 BHK = 412 000 so'm; bank omonatlari kafolati — ~486 BHK (200 000 000 so'm). Diqqat: barcha soliq limitlari BHK da hisoblanmaydi — JShShS imtiyozlari MIH ga (1 271 000 so'm) bog'langan: JShShSga tortilmaydigan moddiy yordam — yiliga 4,22 MIH = 5 363 620 so'm, ipotekani to'lash — yiliga 80 MIH gacha = 101 680 000 so'm.",
      ...
      "Tez hisoblash uchun: 1 BHK = 412 000 so'm; 10 BHK = 4 120 000 so'm; 100 BHK = 41 200 000 so'm; 1 000 BHK = 412 000 000 so'm; 10 000 BHK = 4 120 000 000 so'm. Summalar BHK da ko'rsatilgan qonun hujjatlarini o'qiyotganda, so'mga bir zumda o'girish uchun kalkulyatorimizdan foydalaning.",
    ],
    faqRu: [
      ...
      { question: 'Сколько БРВ составляет порог НДС?', answer: '12 000 БРВ — 4 944 000 000 сум при БРВ 412 000. При доходе выше этой суммы за налоговый период регистрация плательщиком НДС обязательна.' },
    ],
    faqUz: [
      ...
      { question: "QQS chegarasi qancha?", answer: "12 000 BHK — 412 000 so'mlik BHKda 4 944 000 000 so'm. Soliq davri uchun daromad bu summadan oshganda QQS to'lovchisi sifatida ro'yxatdan o'tish majburiy." },
    ],
  },
...

  {
    ...
    paragraphsRu: [
      ...
      'На общей системе налогообложения ООО уплачивает: налог на прибыль — 15% от чистой прибыли (доходы минус документально подтверждённые расходы); НДС — 12% при доходе свыше 12 000 БРВ (4 944 000 000 сум); социальный налог — 12% от фонда оплаты труда; НДФЛ — 12% с зарплат сотрудников (удерживается из зарплаты). Дивиденды учредителям-резидентам облагаются НДФЛ по ставке 5% (нерезидентам — 10%).',
...

  {
    ...
    paragraphsRu: [
      ...
      'Основные размеры пошлин (2026): регистрация права собственности на недвижимость — для физлиц по площади: до 100 м² 1,25 БРВ (515 000 сум), 101-300 м² 2 БРВ (824 000), свыше 300 м² 3 БРВ (1 236 000), для юрлиц 5 БРВ (2 060 000); регистрация юридического лица и регистрация ИП — по 1 БРВ (412 000) при обращении в явочном порядке и вдвое дешевле, 0,5 БРВ (206 000), при подаче через интернет; подача имущественного иска — 4% от суммы иска в гражданских судах, 2% — в экономических (минимум 1 БРВ); регистрация брака — 0,2 БРВ (82 400); расторжение брака через суд — 1,5-3 БРВ (618 000-1 236 000), а если один из супругов вступает в брак повторно — 3-4 БРВ.',
      'Нотариальные пошлины: удостоверение договора купли-продажи недвижимости — фиксированная пошлина 1 БРВ (412 000 сум) в Ташкенте и облцентрах, 0,5 БРВ в иных местностях (не процент от суммы); доверенность — 0,3-1 БРВ; завещание — 0,5 БРВ (206 000 сум); удостоверение копий — 0,1 БРВ за страницу. Нотариусы работают при управлениях юстиции, частные нотариусы взимают дополнительные тарифы.',
    ...
    paragraphsUz: [
      ...
      "Asosiy boj miqdorlari (2026): ko'chmas mulkka egalik huquqini ro'yxatdan o'tkazish — jismoniy shaxslar uchun maydon bo'yicha: 100 m² gacha 1,25 BHK (515 000 so'm), 101-300 m² 2 BHK (824 000), 300 dan ortiq 3 BHK (1 236 000), yuridik shaxslar uchun 5 BHK (2 060 000); yuridik shaxsni va YaTTni ro'yxatdan o'tkazish — yakka tartibda murojaat qilganda 1 BHK (412 000), internet orqali ikki barobar arzon, 0,5 BHK (206 000); sudga mulkiy da'vo arizasi — fuqarolik sudlarida da'vo summasining 4%, iqtisodiy sudlarda 2% (minimum 1 BHK); nikohni ro'yxatdan o'tkazish — 0,2 BHK (82 400); nikohni sud orqali bekor qilish — 1,5-3 BHK (618 000-1 236 000), agar er-xotindan biri takroran nikohga kirsa — 3-4 BHK.",
      "Notarial bojlar: ko'chmas mulk oldi-sotdi shartnomasini tasdiqlash — belgilangan boj 1 BHK (412 000 so'm) Toshkent va viloyat markazlarida, boshqa joylarda 0,5 BHK (foiz emas); ishonchnoma — 0,3-1 BHK; vasiyatnoma — 0,5 BHK (206 000 so'm); nusxalarni tasdiqlash — sahifasiga 0,1 BHK. Notariuslar adliya boshqarmalari huzurida ishlaydi, xususiy notariuslar qo'shimcha tariflar oladi.",
    ...
    faqRu: [
      { question: 'Сколько стоит регистрация собственности?', answer: 'Для физлиц зависит от площади: до 100 м² — 1,25 БРВ (515 000 сум), 101-300 м² — 2 БРВ, свыше 300 — 3 БРВ. Для юрлиц — 5 БРВ (2 060 000). Нотариальное удостоверение договора — фикс. 1 БРВ (412 000).' },
      { question: 'Какая госпошлина за подачу иска?', answer: '4% от суммы имущественного иска в гражданских судах, 2% — в экономических. Минимум — 1 БРВ (412 000 сум). Трудовые споры и алименты — бесплатно.' },
      ...
      { question: 'Сколько стоит регистрация брака?', answer: '0,2 БРВ (82 400 сум) — госпошлина за регистрацию брака. Расторжение через суд — 1,5-3 БРВ (618 000-1 236 000 сум), при повторном браке одного из супругов — 3-4 БРВ.' },
    ...
    faqUz: [
      { question: "Mulkni ro'yxatdan o'tkazish qancha turadi?", answer: "Jismoniy shaxslar uchun maydon bo'yicha: 100 m² gacha 1,25 BHK (515 000 so'm), 101-300 m² 2 BHK, 300 dan ortiq 3 BHK. Yuridik shaxslar uchun 5 BHK (2 060 000). Shartnomani notarial tasdiqlash — belgilangan 1 BHK (412 000)." },
      { question: "Da'vo ariza berish uchun davlat boji qancha?", answer: "Fuqarolik sudlarida mulkiy da'vo summasining 4%, iqtisodiy sudlarda 2%. Minimum — 1 BHK (412 000 so'm). Mehnat nizolari va nafaqa — bepul." },
      ...
      { question: "Nikohni ro'yxatdan o'tkazish qancha turadi?", answer: "Nikohni ro'yxatdan o'tkazish uchun davlat boji — 0,2 BHK (82 400 so'm). Sud orqali bekor qilish — 1,5-3 BHK (618 000-1 236 000 so'm), er-xotindan biri takroran nikohga kirsa — 3-4 BHK." },
...

  {
    ...
    faqRu: [
      { question: 'Какой порог для обязательной регистрации по НДС?', answer: '12 000 БРВ — 4 944 000 000 сум при БРВ 412 000 (с 1 июня 2026, Указ ПФ-100). Считается совокупный доход за налоговый период — календарный год.' },
    ...
    faqUz: [
      { question: "QQS bo'yicha majburiy ro'yxatdan o'tish chegarasi qancha?", answer: "12 000 BHK — 412 000 so'mlik BHKda 4 944 000 000 so'm (2026-yil 1-iyundan, PF-100 Farmoni). Soliq davri — kalendar yil uchun umumiy daromad hisobga olinadi." },
...

  {
    ...
    faqRu: [
      ...
      { question: 'Кто может стать самозанятым?', answer: 'Физические лица с доходом в пределах порога налога с оборота — 12 000 БРВ (4 944 000 000 сум) (прежний лимит 100 млн сум отменён с 2026 года), без наёмных работников, с разрешёнными видами деятельности.' },
    ...
    faqUz: [
      ...
      { question: "Kim o'z-o'zini band qilgan bo'lishi mumkin?", answer: "Daromadi aylanma solig'i chegarasi — 12 000 BHK (4 944 000 000 so'm) doirasidagi (avvalgi 100 mln so'mlik limit 2026-yildan bekor qilindi), yollama xodimsiz, ruxsat etilgan faoliyat turlari bilan jismoniy shaxslar." },
...

  {
    ...
    paragraphsUz: [
      ...
      "2026-yildan soliq yil boshidan ortib boruvchi yakun bilan har oy hisoblanadi va hisobot oyidan keyingi oyning 15-sanasidan kechiktirmay to'lanadi; yillik hisob-kitob 15-fevralgacha topshiriladi. Hisob-kitob my.soliq.uz portali orqali elektron shaklda topshiriladi. Aylanma solig'idan tashqari, soddalashtilgan tizimdagi YaTT ijtimoiy soliq — oyiga 1 BHK (412 000 so'm) qat'iy to'lov, shuningdek yollama xodimlar (bor bo'lsa) ish haqidan JShShS 12% to'laydi.",
    ...
    faqRu: [
      ...
      { question: 'Кто платит налог с оборота?', answer: 'ИП и юрлица на упрощённой системе с совокупным доходом за налоговый период до 12 000 БРВ (4 944 000 000 сум).' },
      ...
      { question: 'Можно ли совмещать с НДС?', answer: 'Нет. На упрощённой системе НДС не уплачивается. При превышении порога 12 000 БРВ (4 944 000 000 сум) необходимо перейти на общую систему с НДС.' },
    ],
    faqUz: [
      ...
      { question: "Aylanma solig'ini kim to'laydi?", answer: "Soliq davri uchun umumiy daromadi 12 000 BHK (4 944 000 000 so'm) gacha bo'lgan soddalashtilgan tizimdagi YaTT va yuridik shaxslar." },
      ...
      { question: "QQS bilan birlashtirish mumkinmi?", answer: "Yo'q. Soddalashtilgan tizimda QQS to'lanmaydi. 12 000 BHK (4 944 000 000 so'm) chegarasidan oshganda QQS bilan umumiy tizimga o'tish kerak." },
    ],
  },
...

  {
    ...
    faqRu: [
      ...
      { question: 'Облагаются ли выплаты при увольнении налогом?', answer: 'Компенсация за отпуск — НДФЛ 12%. Выходное пособие — НДФЛ с суммы свыше 4,22 МРОТ (5 363 620 сум).' },
    ],
    faqUz: [
      ...
      { question: "Ishdan bo'shatish to'lovlari soliqqa tortiladimi?", answer: "Ta'til kompensatsiyasi — JShShS 12%. Chiqish nafaqasi — 4,22 MIH (5 363 620 so'm) dan ortiq summadan JShShS." },
    ],
  },

  {
    ...
    paragraphsUz: [
      "O'zbekistonda nafaqa to'lovchining daromadidan ulushlar sifatida belgilanadi: 1 bolaga — 25% (1/4), 2 bolaga — 33% (1/3), 3 va undan ko'p bolaga — 50% (1/2). Sud qarori bilan nafaqa qat'iy summada tayinlanishi mumkin, agar to'lovchining daromadi muntazam emas, valyutada yoki natural shaklda to'lanadi. Minimal nafaqa miqdori bir bolaga minimal ish haqining 26,5% (MIH 1 271 000 so'mda taxminan 336 800 so'm) dan kam bo'lishi mumkin emas.",
    ...
    faqRu: [
      ...
      { question: 'Какой минимальный размер алиментов?', answer: 'Не менее 26,5% МЗП (≈336 800 сум при МЗП 1 271 000 сум) на одного ребёнка.' },
