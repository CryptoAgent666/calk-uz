...
export const CALCULATOR_ARTICLES: CalculatorArticle[] = [
...

  {
    ...
    faqRu: [
      { question: 'Сколько стоит регистрация собственности?', answer: '3 БРВ (1 236 000 сум) для физлиц, 5 БРВ (2 060 000) для юрлиц. Нотариальное удостоверение — дополнительно фиксированная нотариальная пошлина.' },
