...
export const CALCULATOR_ARTICLES: CalculatorArticle[] = [
...

  {
    ...
    paragraphsRu: [
      'Тарифы на холодную воду для населения Узбекистана (действуют с 2025 года) зависят от наличия счётчика. При наличии водомера оплата производится по фактическому потреблению, при отсутствии — по нормативу на человека. Средний тариф на холодную воду составляет 3 000-5 000 сум/м³, водоотведение (канализация) — дополнительно 1 500-3 000 сум/м³. Калькулятор воды рассчитает стоимость с учётом тарифов вашего региона.',
    ...
    paragraphsUz: [
      "O'zbekiston aholisi uchun sovuq suv tariflari (2025-yildan amal qiladi) hisoblagich mavjudligiga bog'liq. Suv hisoblagich bo'lganda haqiqiy iste'mol bo'yicha, bo'lmaganda — har bir kishiga normativ bo'yicha to'lanadi. Sovuq suvning o'rtacha tarifi 3 000-5 000 so'm/m³, oqava suv (kanalizatsiya) — qo'shimcha 1 500-3 000 so'm/m³.",
