...
export const CALCULATOR_ARTICLES: CalculatorArticle[] = [
...

  {
    ...
    paragraphsRu: [
      ...
      'Для быстрого расчёта: 1 БРВ = 412 000 сум; 10 БРВ = 4 120 000 сум; 100 БРВ = 41 200 000 сум; 1 000 БРВ = 412 000 000 сум; 10 000 БРВ = 4 120 000 000 сум; 1 млрд сум. При чтении законодательных актов, где суммы указаны в БРВ, используйте наш калькулятор для мгновенного перевода в сумы.',
    ],
    paragraphsUz: [
...

  {
    ...
    paragraphsRu: [
      ...
      'На общей системе налогообложения ООО уплачивает: налог на прибыль — 15% от чистой прибыли (доходы минус документально подтверждённые расходы); НДС — 12% при обороте свыше 1 млрд сум; социальный налог — 12% от фонда оплаты труда; НДФЛ — 12% с зарплат сотрудников (удерживается из зарплаты). Дивиденды учредителям облагаются НДФЛ по ставке 5%.',
...

  {
    ...
    paragraphsUz: [
      ...
      "Asosiy boj miqdorlari (2025): ko'chmas mulkka egalik huquqini ro'yxatdan o'tkazish — jismoniy shaxslar uchun maydon bo'yicha: 100 m² gacha 1,25 BHK (515 000 so'm), 101-300 m² 2 BHK (824 000), 300 dan ortiq 3 BHK (1 236 000), yuridik shaxslar uchun 5 BHK (2 060 000); yuridik shaxsni ro'yxatdan o'tkazish — 1 BHK (412 000); YaTTni ro'yxatdan o'tkazish — 0,5 BHK (206 000); sudga da'vo arizasi — jismoniy shaxslar uchun da'vo summasining 2%, yuridik uchun 5% (minimum 1 BHK); nikoh guvohnomasi — 1 BHK (412 000); nikohni sud orqali bekor qilish — 3 BHK (1 236 000).",
...

  {
    ...
    paragraphsRu: [
      'Порог обязательной регистрации плательщиком НДС в Узбекистане составляет 1 млрд сум, что по состоянию на август 2025 года равно 24 720 000 000 сум. Если совокупный оборот предприятия за 12 последовательных месяцев превышает эту сумму, регистрация в качестве плательщика НДС обязательна. Калькулятор порога НДС отслеживает текущий оборот вашего бизнеса и показывает, какой процент от порога вы достигли. Важно учитывать именно скользящий 12-месячный период, а не календарный год.',
...

  {
    ...
    faqRu: [
      ...
      { question: 'Облагаются ли электромобили?', answer: 'С 2026 года электромобили облагаются транспортным налогом — льгота отменена с 31.12.2025 до 2030 года. Гибриды — 50% от базовой ставки.' },
...

  {
    ...
    faqRu: [
      ...
      { question: 'Какие штрафы за налоговые нарушения?', answer: 'Непредставление декларации: 1-3 БРВ. Занижение базы: 20% недоплаты. Деятельность без регистрации: 10-30 БРВ.' },
...

  {
    ...
    faqRu: [
      ...
      { question: 'Какое пособие по уходу за ребёнком?', answer: '60% от МРОТ до 2 лет. Минимум — 50% МЗП (635 500 сум).' },
...

  {
    ...
    paragraphsUz: [
      "O'zbekistonda nafaqa to'lovchining daromadidan ulushlar sifatida belgilanadi: 1 bolaga — 25% (1/4), 2 bolaga — 33% (1/3), 3 va undan ko'p bolaga — 50% (1/2). Sud qarori bilan nafaqa qat'iy summada tayinlanishi mumkin, agar to'lovchining daromadi muntazam emas, valyutada yoki natural shaklda to'lanadi. Minimal nafaqa miqdori bir bolaga minimal ish haqining 50% (2025–2026-yilda 635 500 so'm) dan kam bo'lishi mumkin emas.",
    ...
    faqRu: [
      ...
      { question: 'До какого возраста платят алименты?', answer: 'До 18 лет. Для учащихся для нетрудоспособных совершеннолетних детей.' },
    ],
    faqUz: [
      ...
      { question: "Minimal nafaqa miqdori qancha?", answer: "Bir bolaga MIHning 50% (2025–2026-yilda 635 500 so'm) dan kam emas." },
