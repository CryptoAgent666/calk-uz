...
export const CALCULATOR_ARTICLES: CalculatorArticle[] = [
...

  {
    ...
    paragraphsUz: [
      ...
      "OSAGO polisi 12 oyga rasmiylashtiriladi va sug'urta kompaniyalari ofislarida yoki onlayn sotib olinishi mumkin. OSAGOsiz haydash — ma'muriy huquqbuzarlik (MJtKning 135-1-moddasi): ogohlantirish yoki 0,5 BHK jarima (206 000 so'm).",
    ],
    faqRu: [
      ...
      { question: 'Какой штраф за езду без ОСАГО?', answer: 'Предупреждение или штраф 0,5 БРВ (206 000 сум) по ст. 135-1 Кодекса об административной ответственности.' },
    ...
    faqUz: [
      ...
      { question: "OSAGOsiz haydash uchun jarima qancha?", answer: "Ogohlantirish yoki 0,5 BHK (206 000 so'm) — MJtKning 135-1-moddasi bo'yicha." },
...

  {
    ...
    paragraphsUz: [
      ...
      "Asosiy boj miqdorlari (2026): ko'chmas mulkka egalik huquqini ro'yxatdan o'tkazish — jismoniy shaxslar uchun maydon bo'yicha: 100 m² gacha 1,25 BHK (515 000 so'm), 101-300 m² 2 BHK (824 000), 300 dan ortiq 3 BHK (1 236 000), yuridik shaxslar uchun 5 BHK (2 060 000); yuridik shaxsni ro'yxatdan o'tkazish — 1 BHK (412 000); YaTTni ro'yxatdan o'tkazish — 0,5 BHK (206 000); sudga mulkiy da'vo arizasi — fuqarolik sudlarida da'vo summasining 4%, iqtisodiy sudlarda 2% (minimum 1 BHK); nikoh guvohnomasi — 1 BHK (412 000); nikohni sud orqali bekor qilish — 3 BHK (1 236 000).",
