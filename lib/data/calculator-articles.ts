...
export const CALCULATOR_ARTICLES: CalculatorArticle[] = [
...

  {
    ...
    paragraphsUz: [
      "O'zbekistonda qo'shilgan qiymat solig'i (QQS) stavkasi 12% — MDHdagi eng past stavkalardan biri. QQS tovarlar va xizmatlar narxiga kiritilgan bilvosita soliq bo'lib, amalda yakuniy iste'molchi tomonidan to'lanadi. QQSni hisoblash va to'lash majburiyati ketma-ket 12 oy davomida umumiy aylanmasi 1 mlrd so'm chegarasidan oshgan yuridik shaxslar va yakka tartibdagi tadbirkorlarga yuklatiladi. Aylanmasi bu chegaradan past korxonalar ixtiyoriy ravishda QQS to'lovchisi sifatida ro'yxatdan o'tishi mumkin.",
    ...
    faqRu: [
      ...
      { question: 'Кто обязан платить НДС?', answer: 'Юридические лица и ИП с оборотом более 1 млрд сум за 12 месяцев. Остальные могут зарегистрироваться добровольно.' },
    ...
    faqUz: [
      ...
      { question: "QQS to'lash kimga majburiy?", answer: "12 oy davomida aylanmasi 1 mlrd so'mdan ortiq yuridik shaxslar va YaTTlarga. Qolganlari ixtiyoriy ro'yxatdan o'tishi mumkin." },
...

  {
    ...
    faqRu: [
      ...
      { question: 'Какой порог для уплаты НДС?', answer: '1 млрд сум за 12 месяцев. Ниже этого порога ИП не платит НДС.' },
    ...
    faqUz: [
      ...
      { question: "QQS to'lash uchun chegara qancha?", answer: "12 oy davomida 1 mlrd so'm. Bu chegaradan past bo'lsa YaTT QQS to'lamaydi." },
...

  {
    ...
    paragraphsRu: [
      ...
      'Примеры использования БРВ: порог для обязательной регистрации плательщиком НДС — 1 млрд сум; штраф за вождение без полиса ОСАГО — 0,5 БРВ = 206 000 сум; гарантия по банковским вкладам — ~486 БРВ (200 000 000 сум); имущественный вычет по НДФЛ — 500 БРВ = 206 000 000 сум; материальная помощь, не облагаемая НДФЛ — 4,22 БРВ = 1 738 640 сум/год.',
    ...
    faqRu: [
      ...
      { question: 'Сколько БРВ составляет порог НДС?', answer: '1 млрд сум. При обороте выше этой суммы за 12 месяцев регистрация плательщиком НДС обязательна.' },
    ],
    faqUz: [
      ...
      { question: "QQS chegarasi qancha?", answer: "1 mlrd so'm. 12 oy davomida aylanma bu summadan oshganda QQS to'lovchisi sifatida ro'yxatdan o'tish majburiy." },
    ],
  },
...

  {
    ...
    faqRu: [
      { question: 'Какой порог для обязательной регистрации по НДС?', answer: '1 млрд сум (с августа 2025) за 12 последовательных месяцев.' },
    ...
    faqUz: [
      { question: "QQS bo'yicha majburiy ro'yxatdan o'tish chegarasi qancha?", answer: "Ketma-ket 12 oy uchun 1 mlrd so'm." },
...

  {
    ...
    paragraphsUz: [
      ...
      "Rejimlarni solishtirish: o'z-o'zini band qilgan — aylanmadan 1% (1 mlrd/yilgacha); YaTT — aylanmadan 1% (1 mlrd gacha), aylanma cheklovisiz 4%, 10 tagacha xodim; umumiy tizimdagi MChJ — foydadan 15% + aylanma 1 mlrd so'mdan ortiqda QQS 12%. Sof marja 25% dan kam bo'lganda YaTT MChJdan foydaliroq. Yillik aylanma 1 mlrd dan kam va yollama xodimlar bo'lmaganda o'z-o'zini band qilgan — soliq yuki nuqtai nazaridan shubhasiz optimal tanlov.",
...

  {
    ...
    faqRu: [
      ...
      { question: 'Кто платит налог с оборота?', answer: 'ИП и юрлица на упрощённой системе с оборотом менее 1 млрд сум за 12 месяцев.' },
      ...
      { question: 'Можно ли совмещать с НДС?', answer: 'Нет. На упрощённой системе НДС не уплачивается. При превышении порога 1 млрд сум необходимо перейти на общую систему с НДС.' },
    ],
    faqUz: [
      ...
      { question: "Aylanma solig'ini kim to'laydi?", answer: "Soddalashtilgan tizimdagi 12 oyda 1 mlrd so'mdan kam aylanmali YaTT va yuridik shaxslar." },
      ...
      { question: "QQS bilan birlashtirish mumkinmi?", answer: "Yo'q. Soddalashtilgan tizimda QQS to'lanmaydi. 1 mlrd so'm chegarasidan oshganda QQS bilan umumiy tizimga o'tish kerak." },
    ],
  },
