...
export const CALCULATOR_ARTICLES: CalculatorArticle[] = [
...

  {
    ...
    paragraphsRu: [
      ...
      'Помимо пени, за налоговые правонарушения предусмотрены штрафы. За несвоевременную подачу налоговой декларации: 1 БРВ (440 000 сум) для физлиц/ИП, 3 БРВ для должностных лиц юрлиц в течение года. За занижение налоговой базы: 20% от суммы недоплаченного налога. За ведение деятельности без регистрации: 10% от полученного дохода, но не менее 1 млн сум (ст. 219 НК). За непредставление документов по запросу налогового органа: 5 БРВ.',
    ...
    faqRu: [
      ...
      { question: 'Какие штрафы за налоговые нарушения?', answer: 'Непредставление декларации: 1-3 БРВ. Занижение базы: 20% недоплаты. Деятельность без регистрации: 10% дохода, минимум 1 млн сум.' },
    ...
    faqUz: [
      ...
      { question: "Soliq huquqbuzarliklari uchun qanday jarimalar bor?", answer: "Deklaratsiya topshirmaslik: 1-3 BHK. Bazani kamaytirish: kam to'langan summaning 20%. Ro'yxatdan o'tmasdan faoliyat: daromadning 10%, kamida 1 mln so'm." },
