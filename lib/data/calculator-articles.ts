...
export const CALCULATOR_ARTICLES: CalculatorArticle[] = [
...

  {
    ...
    paragraphsRu: [
      'Тарифы на холодную воду для населения Узбекистана зависят от наличия счётчика. При наличии водомера оплата производится по фактическому потреблению, при отсутствии — по нормативу на человека. В Ташкенте тариф на холодную воду по счётчику составляет 3 808 сум/м³ — эта ставка уже включает водоотведение (канализацию) для холодной и горячей воды, поэтому отдельно канализация не начисляется. В других регионах ставки отличаются. Калькулятор воды рассчитает стоимость по вашему потреблению.',
      'Нормативы потребления при отсутствии счётчика: 150-200 литров в сутки на человека (4,5-6 м³/мес). Пример для семьи из 4 человек по ташкентскому тарифу (холодная вода 3 808 сум/м³, канализация уже включена): по нормативу 24 м³/мес холодной воды = 24 × 3 808 = 91 392 сум. С водомером та же семья обычно расходует 8-12 м³/мес: 10 × 3 808 = 38 080 сум. Экономия — до 50% и более при установке счётчика. Горячая вода считается отдельно по тарифу 8 928,67 сум/м³.',
    ...
    paragraphsUz: [
      "O'zbekiston aholisi uchun sovuq suv tariflari hisoblagich mavjudligiga bog'liq. Suv hisoblagich bo'lganda haqiqiy iste'mol bo'yicha, bo'lmaganda — har bir kishiga normativ bo'yicha to'lanadi. Toshkentda hisoblagich bo'yicha sovuq suv tarifi 3 808 so'm/m³ — bu stavka sovuq va issiq suv uchun kanalizatsiyani (oqava suv) allaqachon o'z ichiga oladi, shuning uchun kanalizatsiya alohida hisoblanmaydi. Boshqa viloyatlarda stavkalar farq qiladi.",
      "Hisoblagichsiz iste'mol normativlari: bir kishiga kuniga 150-200 litr (oyiga 4,5-6 m³). 4 kishilik oila uchun Toshkent tarifi bo'yicha misol (sovuq suv 3 808 so'm/m³, kanalizatsiya kiritilgan): normativ bo'yicha 24 m³/oy sovuq suv = 24 × 3 808 = 91 392 so'm. Hisoblagich bilan xuddi shu oila odatda 8-12 m³/oy sarflaydi: 10 × 3 808 = 38 080 so'm. Tejash — hisoblagich o'rnatishda 50% va undan ko'p. Issiq suv alohida 8 928,67 so'm/m³ tarifi bo'yicha hisoblanadi.",
