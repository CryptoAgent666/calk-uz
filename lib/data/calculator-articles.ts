...
export const CALCULATOR_ARTICLES: CalculatorArticle[] = [
...

  {
    ...
    paragraphsRu: [
      ...
      'Пример расчёта: страховой стаж 6 лет (72 месяца), заработок за 12 месяцев 120 000 000 сум, больничный 15 календарных дней. Среднедневной заработок = 120 000 000 / 365 ≈ 328 767 сум. Стаж до 8 лет даёт 60%: 328 767 × 60% × 15 ≈ 2 958 903 сум (первые 5 дней ≈ 986 301 — работодатель, с 6-го дня ≈ 1 972 602 — ГССФ). Минус НДФЛ 12%: на руки ≈ 2 603 835 сум.',
    ],
    paragraphsUz: [
      ...
      "Hisoblash misoli: sug'urta staji 6 yil (72 oy), 12 oylik daromad 120 000 000 so'm, kasallik 15 taqvim kuni. O'rtacha kunlik daromad = 120 000 000 / 365 ≈ 328 767 so'm. 8 yilgacha staj 60% beradi: 328 767 × 60% × 15 ≈ 2 958 903 so'm (birinchi 5 kun ≈ 986 301 — ish beruvchi, 6-kundan ≈ 1 972 602 — DSSF). Minus JShShS 12%: sof to'lov ≈ 2 603 835 so'm.",
    ],
    faqRu: [
