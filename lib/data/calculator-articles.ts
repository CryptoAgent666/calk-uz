...
export const CALCULATOR_ARTICLES: CalculatorArticle[] = [
...

  {
    ...
    paragraphsRu: [
      ...
      'Расходы владельца возникают разово — при постановке машины на учёт. Госпошлины установлены в базовых расчётных величинах (БРВ = 440 000 сум, с 1 сентября 2026 года — 440 000 сум): регистрация транспортного средства — 6,84 БРВ, свидетельство о регистрации (техпаспорт) — 0,7 БРВ, выдача государственных номерных знаков — 5,5 БРВ. Итого при получении новых номеров — 13,04 БРВ, то есть 5 372 480 сум. Если номера сохраняются за владельцем, платёж уменьшается до 7,54 БРВ (3 106 480 сум).',
    ...
    paragraphsUz: [
      ...
      "Xarajat bir marta — avtomobilni hisobga qo‘yishda yuzaga keladi. Davlat bojlari bazaviy hisoblash miqdorida belgilangan (BHM = 440 000 so‘m, 2026-yil 1-sentabrdan — 440 000 so‘m): transport vositasini ro‘yxatga olish — 6,84 BHM, ro‘yxatga olish guvohnomasi (texpasport) — 0,7 BHM, davlat raqami belgilarini berish — 5,5 BHM. Yangi raqam olinganda jami 13,04 BHM, ya'ni 5 372 480 so‘m. Raqamlar egasida qolsa, to‘lov 7,54 BHM gacha (3 106 480 so‘m) kamayadi.",
    ...
    faqRu: [
      ...
      { question: 'Сколько стоит поставить машину на учёт?', answer: '13,04 БРВ = 5 372 480 сум при получении новых номеров: регистрация 6,84 БРВ, техпаспорт 0,7 БРВ, номера 5,5 БРВ. Со своими номерами — 7,54 БРВ (3 106 480 сум).' },
    ...
    faqUz: [
      ...
      { question: "Avtomobilni hisobga qo‘yish qancha turadi?", answer: "Yangi raqam bilan 13,04 BHM = 5 372 480 so‘m: ro‘yxatga olish 6,84 BHM, texpasport 0,7 BHM, raqamlar 5,5 BHM. O‘z raqamlari bilan — 7,54 BHM (3 106 480 so‘m)." },
...

  {
    ...
    faqRu: [
      ...
      { question: 'Какое пособие по уходу за ребёнком?', answer: 'Фиксированные 60% от МРОТ (762 600 сум/мес) до достижения ребёнком 2 лет, независимо от стажа и числа детей.' },
      { question: 'Какое единовременное пособие при рождении?', answer: 'Государственное пособие («суюнчи пули») — 70,3% МРОТ, около 893 500 сум в 2026 году (ПКМ №110). На первого ребёнка — всем матерям, на второго — семьям в Едином реестре соцзащиты. Работодатель может доплатить отдельно.' },
    ...
    faqUz: [
      ...
      { question: "Bolaga qarashuv nafaqasi qancha?", answer: "Bola 2 yoshga to'lguncha MROTning qat'iy 60% (oyiga 762 600 so'm), staj va bolalar sonidan qat'i nazar." },
      { question: "Tug'ilganda bir martalik nafaqa qancha?", answer: "Davlat nafaqasi («suyunchi puli») — MROTning 70,3%, 2026-yilda qariyb 893 500 so'm (VMQ №110). Birinchi bolaga — barchaga, ikkinchisiga — reestrdagi oilalarga. Ish beruvchi alohida qo'shimcha to'lashi mumkin." },
...

  {
    ...
    faqRu: [
      ...
      { question: 'Какой минимальный размер алиментов?', answer: 'Не менее 26,5% МЗП (≈336 800 сум при МЗП 1 360 000 сум) на одного ребёнка.' },
    ...
    faqUz: [
      ...
      { question: "Minimal nafaqa miqdori qancha?", answer: "Bir bolaga MIHning 26,5% (taxminan 336 800 so'm) dan kam emas." },
