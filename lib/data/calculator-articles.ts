...
export const CALCULATOR_ARTICLES: CalculatorArticle[] = [
...

  {
    ...
    paragraphsRu: [
      ...
      'Пример расчёта: ИП с ежемесячной выручкой 30 000 000 сум. Налог с оборота: 30 000 000 × 4% = 1 200 000 сум. Социальный налог: 440 000 сум (фиксированный). ИНПС: 30 000 000 × 0,1% = 30 000 сум. Итого налогов: 1 642 000 сум/мес (5,5% от выручки). Годовые налоги: 19 704 000 сум при годовом обороте 360 000 000 сум.',
    ...
    paragraphsUz: [
      ...
      "Hisoblash misoli: oylik tushumli 30 000 000 so'mlik YaTT. Aylanma solig'i: 30 000 000 × 4% = 1 200 000 so'm. Ijtimoiy soliq: 440 000 so'm (qat'iy). IJPH: 30 000 000 × 0,1% = 30 000 so'm. Jami soliqlar: 1 642 000 so'm/oy (tushumning 5,5%). Yillik soliqlar: yillik 360 000 000 so'm aylanmada 19 704 000 so'm.",
    ...
    faqRu: [
      { question: 'Сколько налогов платит ИП в Узбекистане?', answer: 'Налог с оборота 1% + социальный налог 440 000 сум/мес + ИНПС 0,1%.' },
    ...
    faqUz: [
      { question: "O'zbekistonda YaTT qancha soliq to'laydi?", answer: "Aylanma solig'i 1% + ijtimoiy soliq 440 000 so'm/oy + IJPH 0,1%." },
...

  {
    ...
    faqRu: [
      { question: 'Какой порог для обязательной регистрации по НДС?', answer: '12 000 БРВ — 5 280 000 000 сум при БРВ 440 000 (с 1 июня 2026, Указ ПФ-100). Считается совокупный доход за налоговый период — календарный год.' },
...

  {
    ...
    paragraphsRu: [
      'Пенсионный возраст в Узбекистане: мужчины — 60 лет, женщины — 55 лет. Женщины с 20-летним трудовым стажем вправе выйти на пенсию на год раньше — в 54 года (ст. 12¹ Закона о государственном пенсионном обеспечении, в редакции ЗРУ-922 от 18.03.2024). Для получения полной пенсии по возрасту необходим минимальный трудовой стаж: 25 лет для мужчин и 20 лет для женщин. При недостаточном стаже (но не менее 7 лет) назначается пенсия в пропорциональном размере. С 1 января 2026 года вступил в силу Закон ЗРУ-1101 от 09.12.2025 «О государственном социальном страховании», который реформирует систему социальных выплат, включая пенсионное обеспечение. Минимальная пенсия по возрасту с 1 июля 2026 года составляет 983 000 сум в месяц.',
    ...
    faqRu: [
      { question: 'Какой пенсионный возраст в Узбекистане?', answer: 'Мужчины — 60 лет, женщины — 55 лет. Женщины со стажем 20+ лет могут выйти на пенсию в 54 года (норма действует с марта 2024 года). Есть и другие категории с правом на досрочную пенсию.' },
    ...
    faqUz: [
      { question: "O'zbekistonda pensiya yoshi necha?", answer: "Erkaklar — 60 yosh, ayollar — 55 yosh. 20+ yil stajli ayollar 54 yoshda pensiyaga chiqishi mumkin (norma 2024-yil martdan amal qiladi). Muddatidan oldingi pensiya huquqiga ega boshqa toifalar ham bor." },
