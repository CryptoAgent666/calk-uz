...
export const CALCULATOR_ARTICLES: CalculatorArticle[] = [
...

  {
    ...
    paragraphsRu: [
      ...
      'Земельный налог уплачивается физическими лицами равными долями до 15 апреля и 15 октября. Кадастровая стоимость земельного участка определяется Государственной кадастровой палатой и зависит от региона: в Ташкенте цена 1 сотки (100 м²) в среднем составляет 30-80 млн сум, в областных центрах — 5-20 млн, в сельской местности — 1-5 млн сум. Уведомление о сумме налога можно получить через портал my.soliq.uz или в местной налоговой инспекции.',
    ...
    paragraphsUz: [
      ...
      "Yer solig'i jismoniy shaxslar tomonidan teng ikki qismda 15-aprel va 15-oktabrgacha to'lanadi. Yer uchastkasining kadastr qiymati Davlat kadastr palatasi tomonidan aniqlanadi va hududga bog'liq: Toshkentda 1 sotixning (100 m²) o'rtacha narxi 30-80 mln so'm, viloyat markazlarida — 5-20 mln, qishloq joylarda — 1-5 mln so'm. Soliq summasi haqidagi bildirishnomani my.soliq.uz portali yoki mahalliy soliq inspektsiyasida olish mumkin.",
    ...
    faqRu: [
      ...
      { question: 'Когда платить земельный налог?', answer: 'Равными долями до 15 апреля и 15 октября текущего года. При просрочке начисляется пеня 1/300 ставки рефинансирования ЦБ в день (при ставке 14% — 0,047%/день).' },
    ],
    faqUz: [
      ...
      { question: "Yer solig'ini qachon to'lash kerak?", answer: "Teng ikki qismda 15-aprel va 15-oktabrgacha. Kechiktirilganda MB qayta moliyalash stavkasining 1/300 qismi kuniga penya hisoblanadi (MB stavkasi 14% da — 0,047%/kun)." },
    ],
  },
