...
export const CALCULATOR_ARTICLES: CalculatorArticle[] = [
...

  {
    ...
    paragraphsRu: [
      'Госпошлина за оформление биометрического паспорта гражданина Узбекистана зависит от типа документа, сроков оформления и возраста заявителя. С 1 сентября 2026 года БРВ = 440 000 сум. Стандартное оформление загранпаспорта (15 рабочих дней): 2 БРВ = 880 000 сум. Ускоренное (5 рабочих дней): 4 БРВ = 1 760 000 сум. Срочное (1-3 дня): 8 БРВ = 3 520 000 сум.',
      'Типы документов и пошлины: ID-карта (внутренний документ удостоверения личности) — 0,5 БРВ (220 000 сум), срок действия 10 лет; загранпаспорт (биометрический) — от 2 БРВ (880 000 сум), срок действия 10 лет; загранпаспорт для несовершеннолетних (до 16 лет) — 1 БРВ (440 000 сум), срок действия 5 лет. Дипломатический и служебный паспорта оформляются бесплатно через МИД.',
      'При утере или порче документа пошлина удваивается: загранпаспорт стандартного оформления при утере — 4 БРВ (1 760 000 сум). Для повторной выдачи необходимо подать заявление в ОВД с объяснительной. Замена по истечении срока действия — стандартная пошлина без надбавок. Смена фамилии или исправление ошибок — 1 БРВ (440 000 сум).',
    ...
    paragraphsUz: [
      ...
      "Pasport bojlari kalkulyatori hujjat turi, shoshilinchlik, arizachining yoshi va murojaat sababi (birinchi marta berish, almashtirish, yo'qotish) ni hisobga olgan holda aniq narxni avtomatik hisoblaydi. To'lov bank terminallari, Click, Payme, Uzum mobil ilovalari yoki bank bo'limlarida amalga oshiriladi. Kvitansiya faqat boj to'langanini tasdiqlaydi (O'RQ-600 qonunining 17-moddasi), uning amal qilish muddati yo'q. Chet elga chiqish pasportiga ariza my.gov.uz orqali berilgan bo'lsa, u yuborilgan kundan boshlab bir oy ichida ma'lumotlarni yig'ish punktiga kelish kerak, aks holda ariza ko'rib chiqilmaydi (PQ-4079 bilan tasdiqlangan Nizomning 20-bandi).",
    ],
    faqRu: [
      { question: 'Сколько стоит загранпаспорт в 2026 году?', answer: 'Стандартное оформление: 2 БРВ (880 000 сум, 15 дней). Ускоренное: 4 БРВ (1 760 000, 5 дней). Срочное: 8 БРВ (3 520 000, 1-3 дня).' },
      { question: 'Сколько стоит ID-карта?', answer: '0,5 БРВ (220 000 сум) при стандартном оформлении. Срок действия — 10 лет.' },
      { question: 'Сколько стоит паспорт при утере?', answer: 'Двойная пошлина. Загранпаспорт: 4 БРВ (1 760 000 сум) при стандартном оформлении вместо обычных 2 БРВ.' },
    ...
    faqUz: [
      { question: "2026-yilda xorijga chiqish pasporti qancha turadi?", answer: "Standart rasmiylashtirish: 2 BHK (880 000 so'm, 15 kun). Tezlashtirilgan: 4 BHK (1 760 000, 5 kun). Shoshilinch: 8 BHK (3 520 000, 1-3 kun)." },
      { question: "ID-karta qancha turadi?", answer: "Standart rasmiylashtirishda 0,5 BHK (220 000 so'm). Amal qilish muddati — 10 yil." },
      { question: "Pasport yo'qotilganda qancha turadi?", answer: "Ikki baravar boj. Xorijga chiqish pasporti: odatdagi 2 BHK o'rniga 4 BHK (1 760 000 so'm)." },
