...
export const CALCULATOR_ARTICLES: CalculatorArticle[] = [
...

  {
    ...
    paragraphsUz: [
      ...
      "OSAGO polisi 12 oyga rasmiylashtiriladi va sug'urta kompaniyalari ofislarida yoki onlayn sotib olinishi mumkin. OSAGOsiz haydash ma'muriy huquqbuzarlik — 1 BHK jarima (412 000 so'm, MJtKning 135-1-moddasi).",
    ],
    faqRu: [
      ...
      { question: 'Какой штраф за езду без ОСАГО?', answer: '1 БРВ (412 000 сум) по ст. 135-1 Кодекса об административной ответственности.' },
    ...
    faqUz: [
      ...
      { question: "OSAGOsiz haydash uchun jarima qancha?", answer: "1 BHK (412 000 so'm) — MJtKning 135-1-moddasi bo'yicha." },
...

  {
    ...
    paragraphsRu: [
      ...
      'Примеры использования БРВ: порог для обязательной регистрации плательщиком НДС — 1 млрд сум; максимальный штраф за вождение без ОСАГО — 1 БРВ = 412 000 сум; гарантия по банковским вкладам — ~486 БРВ (200 000 000 сум); имущественный вычет по НДФЛ — 500 БРВ = 206 000 000 сум; материальная помощь, не облагаемая НДФЛ — 4,22 БРВ = 1 738 640 сум/год.',
