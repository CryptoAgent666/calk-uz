...
export const CALCULATOR_HOWTOS: CalculatorHowTo[] = [
  ...
  },
  {
    ...
    stepsRu: [
      ...
      { name: 'Смотрите результат', text: 'Калькулятор применит ставку НДФЛ 12% и учтёт указанные вычеты.' },
    ...
    stepsUz: [
      ...
      { name: 'Natija darhol chiqadi', text: "Kalkulyator JShShS 12% stavkasini qo'llaydi va ko'rsatilgan chegirmalarni hisobga oladi." },
  ...
  },
  {
    ...
    stepsRu: [
      ...
      { name: 'Получите расчёт пошлин', text: 'Результат появится сразу: акциз, таможенную пошлину, НДС и общую сумму.' },
    ],
    stepsUz: [
      ...
      { name: "Bojlar hisobini oling", text: "Natija darhol chiqadi — aksiz, bojxona boji, QQS va umumiy summani ko'ring." },
    ],
  },
  {
    slug: 'electricity',
    ...
    stepsRu: [
      ...
      { name: 'Получите сумму оплаты', text: 'Результат появится сразу — вы узнаете сумму к оплате за электричество.' },
    ],
    stepsUz: [
      ...
      { name: "To'lov summasini oling", text: "Natija darhol chiqadi — elektr energiya uchun to'lov summasini bilib oling." },
    ],
  },
  {
    slug: 'gas',
    ...
    stepsRu: [
      ...
      { name: 'Получите сумму оплаты', text: 'Результат появится сразу — вы узнаете стоимость потреблённого газа.' },
    ],
    stepsUz: [
      ...
      { name: "To'lov summasini oling", text: "Natija darhol chiqadi — sarflangan gaz narxini bilib oling." },
    ],
  },
  {
    slug: 'water',
    ...
    stepsRu: [
      ...
      { name: 'Получите сумму оплаты', text: 'Результат появится сразу — вы узнаете стоимость водоснабжения и водоотведения.' },
    ],
    stepsUz: [
      ...
      { name: "To'lov summasini oling", text: "Natija darhol chiqadi — suv ta'minoti va kanalizatsiya narxini bilib oling." },
    ],
  },
  {
    slug: 'vat',
  ...
  },
  {
    ...
    stepsRu: [
      ...
      { name: 'Получите расчёт налогов', text: 'Результат появится сразу: все налоги, взносы и чистый доход ИП.' },
    ],
    stepsUz: [
      ...
      { name: 'Soliqlar hisobini oling', text: "Natija darhol chiqadi — barcha soliqlar, badal va YaTTning sof daromadini ko'ring." },
    ],
  },
  {
  ...
  },
  {
    ...
    stepsRu: [
      ...
      { name: 'Получите сумму отпускных', text: 'Результат появится сразу — вы узнаете сумму отпускных за вычетом НДФЛ.' },
    ],
    stepsUz: [
      ...
      { name: "Ta'til pulini oling", text: "Natija darhol chiqadi — JShShS chegirilgandan keyin ta'til puli summasini bilib oling." },
    ],
  },
  {
    slug: 'sick-leave',
    ...
    stepsRu: [
      ...
      { name: 'Получите расчёт', text: 'Результат появится сразу: сумму пособия по временной нетрудоспособности.' },
    ],
    stepsUz: [
      ...
      { name: 'Hisobni oling', text: "Natija darhol chiqadi — vaqtinchalik mehnatga layoqatsizlik nafaqasi summasini oling." },
    ],
  },
  {
    slug: 'maternity',
  ...
  },
  {
    ...
    stepsRu: [
      ...
      { name: 'Получите стоимость полиса', text: 'Результат появится сразу — вы узнаете стоимость полиса ОСАГО.' },
    ],
    stepsUz: [
      ...
      { name: 'Polis narxini oling', text: "Natija darhol chiqadi — OSAGO polisi narxini bilib oling." },
    ],
  },
  {
  ...
  },
  {
    ...
    stepsRu: [
      ...
      { name: 'Получите расчёт налога', text: 'Результат появится сразу — вы узнаете годовой налог на имущество.' },
    ],
    stepsUz: [
      ...
      { name: 'Soliq hisobini oling', text: "Natija darhol chiqadi — yillik mol-mulk solig'ini bilib oling." },
    ],
  },
  {
    slug: 'vehicle-tax',
  ...
  },
  {
    ...
    stepsRu: [
      ...
      { name: 'Получите результат', text: 'Результат появится сразу — узнайте, обязаны ли вы платить НДС при текущей выручке.' },
    ],
    stepsUz: [
      ...
      { name: 'Natijani oling', text: "Natija darhol chiqadi — joriy tushum bilan QQS to'lash majburiyatingiz borligini bilib oling." },
    ],
  },
  {
    slug: 'land-tax',
    ...
    stepsRu: [
      ...
      { name: 'Получите расчёт налога', text: 'Результат появится сразу — вы узнаете годовой земельный налог.' },
    ],
    stepsUz: [
      ...
      { name: 'Soliq hisobini oling', text: "Natija darhol chiqadi — yillik yer solig'ini bilib oling." },
    ],
  },
  {
    slug: 'corporate-tax',
    ...
    stepsRu: [
      ...
      { name: 'Получите расчёт', text: 'Результат появится сразу: сумму налога на прибыль и эффективную ставку.' },
    ],
    stepsUz: [
      ...
      { name: 'Hisobni oling', text: "Natija darhol chiqadi — foyda solig'i summasini va samarali stavkani ko'ring." },
    ],
  },
  {
    slug: 'tax-penalty',
    ...
    stepsRu: [
      ...
      { name: 'Получите расчёт пени', text: 'Результат появится сразу — вы узнаете сумму пени и штрафа за просрочку.' },
    ],
    stepsUz: [
      ...
      { name: "Penya hisobini oling", text: "Natija darhol chiqadi — kechikish uchun penya va jarima summasini bilib oling." },
    ],
  },
  {
    slug: 'self-employed',
    ...
    stepsRu: [
      ...
      { name: 'Получите расчёт', text: 'Результат появится сразу — вы узнаете налоги и взносы самозанятого.' },
    ],
    stepsUz: [
      ...
      { name: 'Hisobni oling', text: "Natija darhol chiqadi — o'z-o'zini band qilganlarning soliq va badallarini bilib oling." },
    ],
  },
  {
    slug: 'turnover-tax',
    ...
    stepsRu: [
      ...
      { name: 'Получите расчёт', text: 'Результат появится сразу — вы узнаете сумму налога с оборота.' },
    ],
    stepsUz: [
      ...
      { name: 'Hisobni oling', text: "Natija darhol chiqadi — aylanma solig'i summasini bilib oling." },
    ],
  },
  {
    slug: 'severance',
    ...
    stepsRu: [
      ...
      { name: 'Получите расчёт', text: 'Результат появится сразу — вы узнаете размер выходного пособия.' },
    ],
    stepsUz: [
      ...
      { name: 'Hisobni oling', text: "Natija darhol chiqadi — ishdan bo'shatish nafaqasi miqdorini bilib oling." },
    ],
  },
  {
    slug: 'overtime',
  ...
  },
  {
    ...
    stepsRu: [
      ...
      { name: 'Получите график платежей', text: 'Результат появится сразу: ежемесячный платёж и полный график.' },
    ],
    stepsUz: [
      ...
      { name: "To'lov jadvalini oling", text: "Natija darhol chiqadi — oylik to'lov va to'liq jadvalni ko'ring." },
    ],
  },
  {
  ...
  },
  {
    ...
    stepsRu: [
      ...
      { name: 'Получите расчёт', text: 'Результат появится сразу — вы узнаете стоимость поездки.' },
    ],
    stepsUz: [
      ...
      { name: 'Hisobni oling', text: "Natija darhol chiqadi — sayohat narxini bilib oling." },
    ],
  },
  {
    slug: 'car-leasing',
  ...
  },
  {
    ...
    stepsRu: [
      ...
      { name: 'Получите расчёт', text: 'Результат появится сразу — вы узнаете ежемесячную стоимость интернета.' },
    ],
    stepsUz: [
      ...
      { name: 'Hisobni oling', text: "Natija darhol chiqadi — oylik internet narxini bilib oling." },
    ],
  },
  {
  ...
  },
  {
    ...
    stepsRu: [
      ...
      { name: 'Получите оценку стоимости', text: 'Результат появится сразу — вы узнаете примерную стоимость квартиры.' },
    ],
    stepsUz: [
      ...
      { name: 'Narx baholashini oling', text: "Natija darhol chiqadi — kvartiraning taxminiy narxini bilib oling." },
    ],
  },
  {
    slug: 'rental',
    ...
    stepsRu: [
      ...
      { name: 'Получите расчёт', text: 'Результат появится сразу — вы узнаете рекомендуемую стоимость аренды.' },
    ],
    stepsUz: [
      ...
      { name: 'Hisobni oling', text: "Natija darhol chiqadi — tavsiya etilgan ijara narxini bilib oling." },
    ],
  },
  {
    slug: 'renovation',
  ...
  },
  {
    ...
    stepsRu: [
      ...
      { name: 'Получите расчёт расходов', text: 'Результат появится сразу — вы узнаете затраты на регистрацию ООО.' },
    ],
    stepsUz: [
      ...
      { name: 'Xarajatlar hisobini oling', text: "Natija darhol chiqadi — MChJ ro'yxatdan o'tkazish xarajatlarini bilib oling." },
    ],
  },
  {
    slug: 'break-even',
  ...
  },
  {
    ...
    stepsRu: [
      ...
      { name: 'Получите расчёт', text: 'Результат появится сразу — вы узнаете полную стоимость сотрудника для работодателя.' },
    ],
    stepsUz: [
      ...
      { name: 'Hisobni oling', text: "Natija darhol chiqadi — ish beruvchi uchun xodimning to'liq qiymatini bilib oling." },
    ],
  },
  {
    slug: 'ideal-weight',
  ...
  },
  {
    ...
    stepsRu: [
      ...
      { name: 'Получите нормы БЖУ', text: 'Результат появится сразу: суточные нормы белков, жиров и углеводов.' },
    ],
    stepsUz: [
      ...
      { name: 'OYU normalarini oling', text: "Natija darhol chiqadi — kunlik oqsil, yog' va uglevodlar normasini oling." },
    ],
  },
  {
    slug: 'pregnancy',
    ...
    stepsRu: [
      ...
      { name: 'Получите результат', text: 'Результат появится сразу — вы узнаете предполагаемую дату родов и срок беременности.' },
    ],
    stepsUz: [
      ...
      { name: 'Natijani oling', text: "Natija darhol chiqadi — taxminiy tug'ilish sanasi va homiladorlik muddatini bilib oling." },
    ],
  },
  {
    slug: 'tuition',
    ...
    stepsRu: [
      ...
      { name: 'Получите стоимость', text: 'Результат появится сразу — вы узнаете стоимость контракта за год.' },
    ],
    stepsUz: [
      ...
      { name: 'Narxni oling', text: "Natija darhol chiqadi — yillik kontrakt narxini bilib oling." },
    ],
  },
  {
    slug: 'education-loan',
  ...
  },
  {
    ...
    stepsRu: [
      ...
      { name: 'Получите расчёт', text: 'Результат появится сразу — вы узнаете сумму фитр-садака на каждого человека.' },
    ],
    stepsUz: [
      ...
      { name: 'Hisobni oling', text: "Natija darhol chiqadi — har bir kishi uchun fitr-sadaqa summasini bilib oling." },
    ],
  },
  {
    slug: 'fidiya-sadaka',
  ...
  },
  {
    ...
    stepsRu: [
      ...
      { name: 'Получите результат', text: 'Результат появится сразу: итоговую дату или количество дней.' },
    ],
    stepsUz: [
      ...
      { name: 'Natijani oling', text: "Natija darhol chiqadi — yakuniy sana yoki kunlar sonini oling." },
    ],
  },
  {
    slug: 'area',
    ...
    stepsRu: [
      ...
      { name: 'Получите площадь', text: 'Результат появится сразу: площадь и периметр фигуры.' },
    ],
    stepsUz: [
      ...
      { name: 'Yuzani oling', text: "Natija darhol chiqadi — shaklning yuzi va perimetrini oling." },
    ],
  },
  {
    slug: 'unit-converter',
  ...
  },
  {
    ...
    stepsRu: [
      ...
      { name: 'Получите расчёт', text: 'Результат появится сразу — вы узнаете госпошлину за оформление паспорта.' },
    ],
    stepsUz: [
      ...
      { name: 'Hisobni oling', text: "Natija darhol chiqadi — pasport rasmiylashtirishning davlat boji summasini bilib oling." },
    ],
  },
  {
    slug: 'state-duties',
  ...
  },
  {
    ...
    stepsRu: [
      ...
      { name: 'Получите сумму', text: 'Результат появится сразу — вы узнаете сумму в сумах для указанного количества БРВ.' },
    ],
    stepsUz: [
      ...
      { name: 'Summani oling', text: "Natija darhol chiqadi — ko'rsatilgan BHM soni uchun so'mdagi summani bilib oling." },
    ],
  },
]
